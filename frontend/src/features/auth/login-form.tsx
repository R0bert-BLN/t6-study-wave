  ...
  return (
    <FormProvider value={form}>
      <div className="mx-auto w-full max-w-sm rounded-[2rem] border border-zinc-100 bg-white/80 p-10 shadow-2xl shadow-zinc-200/50 backdrop-blur-xl">
        ...
        >
          <InputField name="email" label="Email" variant="underline" type="email" />
          <InputField name="password" label="Password" variant="underline" type="password" />

          <SubmitButton isLoading={isPending} label="Login" className="main-btn" />
        </form>
      </div>
    </FormProvider>
  );
